...
// calculateSalePrice should take a product name and price as arguments, add a 20% discount, and return formatted 
// string in the format "Product: [name] - Sale Price: $[price with markup]"
